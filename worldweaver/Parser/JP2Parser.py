...
from worldweaver.Utils.Utils import GeoWindow, CRS_fr, safe_overlay, OverlayType
...
class JP2Parser:
    ...
    def create_texture_img(
        ...
        slab_parts = safe_overlay(slabs, geo_window.dataframe, OverlayType.INTERSECTION)
