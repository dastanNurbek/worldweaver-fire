...
from worldweaver.Drivers.IGN.Utils import WFS_FR
...
from worldweaver.Parser.WFSParser import WFSParser

from worldweaver.Utils.Logging import logger
from worldweaver.Utils.Utils import GeoWindow, CRS_fr, CRS_degrees
